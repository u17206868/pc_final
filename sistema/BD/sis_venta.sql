...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-07-2021 a las 08:30:07
...
PROCEDURE `actualizar_precio_producto` (IN `n_cantidad` INT, IN `n_precio` DECIMAL(10,2), IN `codigo` INT)  BEGIN
...
(2, 75974046, 'kelvin', 924639294, 'av.los jeronimos', 1),
(3, 1, '', 0, '', 11);
...
(1, 2049847505, 'PLASTICOS CONTINENTAL S.A.C.', 'PLASTICOS CONTINENTAL S.A.C.', 54461919, 'plasticoscontinental@gmail.com', 'Arequipa- Perú', '18.00');
...
(21, 'c4ca4238a0b923820dcc509a6f75849b', 1, 1, '1560.00'),
(30, '6512bd43d9caa6e02c990b0a82652dca', 2, 1, '2500.00');
...
(1, '2021-07-05 09:21:56', 1, 2, '1560.00', 1),
(2, '2021-07-16 11:53:26', 1, 1, '1560.00', 1),
(3, '2021-07-16 11:59:37', 1, 1, '7000.00', 1),
(4, '2021-07-19 23:54:05', 11, 1, '8500.00', 1),
(5, '2021-07-19 23:57:00', 11, 1, '8060.00', 1),
(6, '2021-07-19 23:58:25', 11, 1, '1560.00', 1);
...
(1, 'Laptop lenovo', 1, '1560.00', 45, 2),
(2, 'Televisor', 1, '2500.00', 75, 1),
(6, 'Impresora', 1, '800.00', 0, 1),
(7, 'Gaseosa', 3, '1500.00', -3, 1);
...
(1, 'Plasticos Continental', 'Plasticoscontinental@gmail.com', 'admin', '21232f297a57a5a743894a0e4a801fc3', 1),
(11, 'maya', 'maya@gmail.com', 'maya', 'b2693d9c2124f3ca9547b897794ac6a1', 2);
